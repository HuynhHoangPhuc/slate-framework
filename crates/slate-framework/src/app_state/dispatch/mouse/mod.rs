...
//!
//! Submodules hold the per-event-class dispatchers; the shared chain-walking
//! helpers (`ancestors`, `bubble_*`, `fire_hover_transitions`, `button_to_bit`)
//! live here because every mouse dispatcher uses them.
